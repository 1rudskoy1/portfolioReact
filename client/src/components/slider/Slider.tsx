    ...
    <div className='slider-wrap'>
        ...
        <div className='slider-down'>
            {people.map((person, personIndex) => {
                ...
                return (
                    <>
                        <div className={"slider-down-container "} key={id} style={{left: (((id-1) + -index) * 33) + "%", opacity: id -1 === index ? .4 : 1}} onClick={() => setIndex(id-1)}>
                            <img src={image} alt="" />
                        </div>
                    </>
                )
        ...
        <div className='slider-down-arrays'>
                <div className='slider-down-arrays__array array-left' onClick={() => setIndex(index -1)}><svg xmlns="http://www.w3.org/2000/svg" width="34" height="55" viewBox="0 0 34 55" fill="none">
                    ...
                    <defs>
                    <filter id="filter0_d_206_28510" x="0.524902" y="0.736084" width="32.7529" height="53.8328" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
